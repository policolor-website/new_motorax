...
const generateFaqs = (brandName: string) => [
  ...
  {
    q: `Is DAS Tuning a ${brandName} service center?`,
    a: `Yes. DAS Tuning operates as a specialized ${brandName} service center, offering expert servicing, diagnostics, and performance upgrades carried out by technicians who understand ${brandName} engineering in depth.`,
  },
  {
