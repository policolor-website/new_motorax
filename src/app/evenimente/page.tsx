...
const pastEvents = [
  ...
  {
    title: "DAS Dyno Day – BMW Performance Showcase",
    date: "March 22, 2026",
    location: "DAS Tuning HQ, Al Quoz, Dubai",
...
// ============================================
const galleryImages = [
  { src: "/das/gallery/featured-1.png", alt: "DAS Tuning community event" },
  { src: "/das/gallery/featured-2.png", alt: "DAS Tuning performance showcase" },
  { src: "/das/gallery/featured-3.png", alt: "DAS Tuning dyno day" },
  { src: "/das/gallery/featured-4.png", alt: "DAS Tuning car meet" },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-ash max-w-2xl mx-auto">
              Explore the highlights, relive the energy, and see the builds that stole the spotlight. Tag your photos and videos with #dastuning for a chance to be featured in our cinematic community gallery.
            </p>
          </motion.div>
